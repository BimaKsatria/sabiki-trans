...
<form id="form-POSTapi--panel--users" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi--panel--users');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi--panel--users"
                    onclick="cancelTryOut('POSTapi--panel--users');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PUTapi--panel--users--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi--panel--users--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi--panel--users--id-"
                    onclick="cancelTryOut('PUTapi--panel--users--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-DELETEapi--panel--users--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi--panel--users--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi--panel--users--id-"
                    onclick="cancelTryOut('DELETEapi--panel--users--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi--panel--users--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi--panel--users--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi--panel--users--id-"
                    onclick="cancelTryOut('GETapi--panel--users--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-customers-user--user_id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-customers-user--user_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-customers-user--user_id-"
                    onclick="cancelTryOut('GETapi-customers-user--user_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-rentals--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-rentals--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-rentals--id-"
                    onclick="cancelTryOut('GETapi-rentals--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PUTapi-rentals--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-rentals--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-rentals--id-"
                    onclick="cancelTryOut('PUTapi-rentals--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-DELETEapi-rentals--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-rentals--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-rentals--id-"
                    onclick="cancelTryOut('DELETEapi-rentals--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-ratings-car--cars_id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-ratings-car--cars_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-ratings-car--cars_id-"
                    onclick="cancelTryOut('GETapi-ratings-car--cars_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-ratings-car--cars_id--average" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-ratings-car--cars_id--average');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-ratings-car--cars_id--average"
                    onclick="cancelTryOut('GETapi-ratings-car--cars_id--average');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-payments-notification" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-payments-notification');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-payments-notification"
                    onclick="cancelTryOut('POSTapi-payments-notification');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-payments-midtrans-status--order_id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-payments-midtrans-status--order_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-payments-midtrans-status--order_id-"
                    onclick="cancelTryOut('GETapi-payments-midtrans-status--order_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-payments-bookinguser--user_id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-payments-bookinguser--user_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-payments-bookinguser--user_id-"
                    onclick="cancelTryOut('GETapi-payments-bookinguser--user_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-car-categories" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-car-categories');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-car-categories"
                    onclick="cancelTryOut('GETapi-car-categories');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-available-cars" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-available-cars');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-available-cars"
                    onclick="cancelTryOut('GETapi-available-cars');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-rentals-with-details" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-rentals-with-details');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-rentals-with-details"
                    onclick="cancelTryOut('GETapi-rentals-with-details');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-discount-usages" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-discount-usages');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-discount-usages"
                    onclick="cancelTryOut('GETapi-discount-usages');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-discount-usages" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-discount-usages');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-discount-usages"
                    onclick="cancelTryOut('POSTapi-discount-usages');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-discount-usages--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-discount-usages--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-discount-usages--id-"
                    onclick="cancelTryOut('GETapi-discount-usages--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PUTapi-discount-usages--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-discount-usages--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-discount-usages--id-"
                    onclick="cancelTryOut('PUTapi-discount-usages--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-DELETEapi-discount-usages--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-discount-usages--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-discount-usages--id-"
                    onclick="cancelTryOut('DELETEapi-discount-usages--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-discount-usages-record" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-discount-usages-record');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-discount-usages-record"
                    onclick="cancelTryOut('POSTapi-discount-usages-record');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-rentals-check-availability" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-rentals-check-availability');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-rentals-check-availability"
                    onclick="cancelTryOut('POSTapi-rentals-check-availability');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-get-available-cars" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-get-available-cars');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-get-available-cars"
                    onclick="cancelTryOut('GETapi-get-available-cars');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-banner" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-banner');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-banner"
                    onclick="cancelTryOut('GETapi-banner');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-test-sheets" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-test-sheets');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-test-sheets"
                    onclick="cancelTryOut('GETapi-test-sheets');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-tes-sheets" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-tes-sheets');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-tes-sheets"
                    onclick="cancelTryOut('GETapi-tes-sheets');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
